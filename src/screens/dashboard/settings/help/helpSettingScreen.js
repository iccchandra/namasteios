...
class helpSettingScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
            ...
            <Header transparent>
                <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between',}}>
                    <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
                        ...
                        <View>
                            <Text style={[{marginLeft: 5,fontSize: 14, fontWeight: '800', color: theme.primaryColor}]}>{`Help`}</Text>
                        </View>
                    </View>
                    <Right/>
                </View>
...
export default connect(mapStateToProps)(helpSettingScreen);
